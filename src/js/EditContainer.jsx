...
import StoryLinkCard from './Container.jsx';
import JSONSchemaForm from '../../lib/js/react-jsonschema-form';

export default class EditStoryLinkCard extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
      step: 1,
  ...
  exportData() {
    ...
    getDataObj["name"] = getDataObj.dataJSON.data.description.substr(0,225); // Reduces the name to ensure the slug does not get too long
    return getDataObj;
  }
